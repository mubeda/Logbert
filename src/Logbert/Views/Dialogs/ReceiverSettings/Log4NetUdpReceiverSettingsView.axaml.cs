...
{
    public Log4NetUdpReceiverSettingsViewModel? ViewModel => DataContext as Log4NetUdpReceiverSettingsViewModel;

    public Log4NetUdpReceiverSettingsView()
    {
        InitializeComponent();
        DataContext = new Log4NetUdpReceiverSettingsViewModel();
    }
