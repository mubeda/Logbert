...
public partial class NLogTcpReceiverSettingsView : Window
{
    public NLogTcpReceiverSettingsViewModel? ViewModel => DataContext as NLogTcpReceiverSettingsViewModel;

    public NLogTcpReceiverSettingsView()
    {
        InitializeComponent();
        DataContext = new NLogTcpReceiverSettingsViewModel();
    }
