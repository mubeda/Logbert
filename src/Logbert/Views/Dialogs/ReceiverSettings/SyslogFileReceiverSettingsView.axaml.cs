...
{
    public SyslogFileReceiverSettingsViewModel? ViewModel => DataContext as SyslogFileReceiverSettingsViewModel;

    public SyslogFileReceiverSettingsView()
    {
        InitializeComponent();
        DataContext = new SyslogFileReceiverSettingsViewModel();
    }
